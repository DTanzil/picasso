...
if ( $attachment_ids ) {
	...
	<!-- Product Gallery main image selection dots-->
	<div class="pi-thumbnails-dots">
		<a><span tabindex="1" class="circle selected">&nbsp;</span></a>
		<?php $count = 2; ?>
		<?php foreach ( $attachment_ids as $attachment_id ) { ?>
			<a><span tabindex="<?=$count?>" class="circle">&nbsp;</span></a>
			<?php $count++; ?>
		<?php } ?>
	</div>

	<div class="thumbnails <?php echo 'columns-' . $columns; ?>" style="display:none;"><?php
