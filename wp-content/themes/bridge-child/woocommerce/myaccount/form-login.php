...
<?php endif; ?>
        ...
        <form method="post" class="login pi-border">

            <?php do_action( 'woocommerce_login_form_start' ); ?>

            <p class="form-row form-row-wide pi-login-icon">
                <label><?php _e( 'Username or email', 'woocommerce' ); ?><span class="required">*</span></label>
            ...
            <p class="form-row">
                ...
                <input id="pi-button" type="submit" class="button" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" /> 
                <label for="rememberme" class="inline woo-my-account-rememberme">
                    <input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php _e( 'Remember me', 'woocommerce' ); ?>
                </label><br/>
                <a class="lost_password woo-lost_password2" href="<?php echo esc_url( wc_lostpassword_url() ); ?>"><?php _e( 'FORGOT PASSWORD ?', 'woocommerce' ); ?></a>
                <br/>
                <div style="" class="transparent"></div>
                <a class="lost_password woo-lost_password2" href="<?php echo esc_url( 'http://picassohome.co.id/sign-up' ); ?>"><?php _e( 'CREATE NEW ACCOUNT', 'woocommerce' ); ?></a>
            </p>
