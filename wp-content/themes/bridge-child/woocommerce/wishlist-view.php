                    ...
                    <tr id="yith-wcwl-row-<?php echo $item['prod_id'] ?>" data-row-id="<?php echo $item['prod_id'] ?>">
                        ...
                        <td class="product-add-to-cart">
                            ...
                            <?php if( $show_add_to_cart && isset( $stock_status ) && $stock_status != 'Out' ): ?>
                                ...
                                if(pi_archive_custom_wishlist_button_text($product->id)) {
                                    $cart_url = $woocommerce->cart->get_cart_url();
                                    echo '<p style="text-align:center;text-decoration: underline;" class="pi-to-cart"><a href="'.$cart_url.'">VIEW CART</a></p>';
                                }
                                else 
                                {
