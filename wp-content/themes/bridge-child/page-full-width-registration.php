<?php 
/*
Template Name: Custom Template My Account - Registration 
*/ 
?>
<?php 
global $wp_query;
		...
		<?php if(($sidebar == "default")||($sidebar == "")) : ?>
			<?php if (have_posts()) : 
					while (have_posts()) : the_post(); ?>
							<?php pi_page_html_start(); ?>
								<h2> CREATE NEW ACCOUNT </h2>
								<div class="woocommerce pi-border">	
									<?php wc_get_template( 'myaccount/pi-form-signup.php' ); ?>
								</div>
							<?php pi_page_html_end(); ?>
					<?php 
 $args_pages = array(
