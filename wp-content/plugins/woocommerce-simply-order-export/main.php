	...
	class WooCommerce_simply_order_export {
		...
		function set_variables() {
			...
			$this->wpg_order_columns = apply_filters( 'wpg_order_columns', array(
												...
												// 'wc_settings_tab_product_tax' =>__( 'Product Tax', 'woocommerce-simply-order-export' ),
												'wc_settings_tab_order_date'=>__( 'Order Date', 'woocommerce-simply-order-export' ),
												
												'wc_settings_tab_product_subtotal'=>__( 'Product Subtotal Price', 'woocommerce-simply-order-export' ),
												'wc_settings_tab_product_total'=>__( 'Product Total Price', 'woocommerce-simply-order-export' ),
												'wc_settings_tab_product_tax_subtotal'=>__( 'Product Subtotal Tax', 'woocommerce-simply-order-export' ),
												'wc_settings_tab_product_tax_total'=>__( 'Product Total Tax', 'woocommerce-simply-order-export' ),
												'wc_settings_tab_product_sku'=>__( 'Product SKU', 'woocommerce-simply-order-export' ),
