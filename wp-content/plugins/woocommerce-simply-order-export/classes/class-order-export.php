	...
	class wpg_order_export {
		...
		static function get_settings_fields() {
			...
			$settings = array(
				...
				// dania edit
				// 'product_tax' => array(
				// 	'name' => __( 'Product Tax', 'woocommerce-simply-order-export' ),
				// 	'type' => 'checkbox',
				// 	'desc' => __( 'Product Tax', 'woocommerce-simply-order-export' ),
				// 	'id'   => 'wc_settings_tab_product_tax'
				// ),
				...
				'product_subtotal' => array(
					'name' => __( 'Product Subtotal Price', 'woocommerce-simply-order-export' ),
					'type' => 'checkbox',
					'desc' => __( 'Product Subtotal Price', 'woocommerce-simply-order-export' ),
					'id'   => 'wc_settings_tab_product_subtotal'
				),
				'product_total' => array(
					'name' => __( 'Product Total Price', 'woocommerce-simply-order-export' ),
					'type' => 'checkbox',
					'desc' => __( 'Product Total Price', 'woocommerce-simply-order-export' ),
					'id'   => 'wc_settings_tab_product_total'
				),
				'product_tax_subtotal' => array(
					'name' => __( 'Product Subtotal Tax', 'woocommerce-simply-order-export' ),
					'type' => 'checkbox',
					'desc' => __( 'Product Subtotal Tax', 'woocommerce-simply-order-export' ),
					'id'   => 'wc_settings_tab_product_tax_subtotal'
				),
				'product_tax_total' => array(
					'name' => __( 'Product Total Tax', 'woocommerce-simply-order-export' ),
					'type' => 'checkbox',
					'desc' => __( 'Product Total Tax', 'woocommerce-simply-order-export' ),
					'id'   => 'wc_settings_tab_product_tax_total'
				),
				'product_sku' => array(
					'name' => __( 'Product SKU', 'woocommerce-simply-order-export' ),
					'type' => 'checkbox',
					'desc' => __( 'Product SKU', 'woocommerce-simply-order-export' ),
					'id'   => 'wc_settings_tab_product_sku'
				),
